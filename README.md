...
|:------------|:------------|
| <img src="./images/Indiana%20University%20Logo.jpg" width="75"/> | **IU SEC Lab**, Department of Computer Science, *Indiana University Bloomington*  <br> **Position:** Research Intern (Oct 2025 – Present, Bloomington, U.S.)  <br> **Supervisor:** Prof. Hyungsub Kim  <br> Researching open-source CPS (Cyber-Physical System) software security.  <br> 🔗 [Lab Homepage](https://kimhyungsub.github.io/) |
| <img src="./images/dankook_logo.png" width="120"/> | **CSOS Lab**, Department of Software Science, *Dankook University*  <br> **Position:** Research Intern (Mar 2025 – Present, Yongin, South Korea)  <br> **Supervisor:** Prof. Seongje Cho  <br> Developing Android malware detection AI models using static analysis and machine learning.  <br> 🔗 [Lab Homepage](https://securesw.dankook.ac.kr/) |

---

## 🎓 Education
**Dankook University**  
*B.E. in Cybersecurity* (Mar 2021 – Expected Jan 2027)  
GPA: 3.0 / 4.5 (≈ 2.7 / 4.0 U.S. Scale)  
_Yongin, Republic of Korea_

---

## 📚 Publications, Conferences, and Patents

**C = Conference | J = Journal | P = Patent | T = Thesis**
...
- **Turing Cipher Idea Contest – 1st Place** — *Dankook University Cybersecurity Dept., sponsored by NIS (National Intelligence Service)*  
...
## 💥 Security-Related & CTF Experiences

- **RubiyaLab CTF Team** (Jul 2025 – Present)  
  - Member of South Korea’s #1 and Global Top 11 CTF team.  
  - Specializes in crypto and reversing; participates in international competitions under RubiyaLab.  
...
- **Rural Volunteer Program** — *Korea Federation of Volunteer Centers* (Sep 2025)  
  - Participated in national agricultural volunteering initiative in Buyeo County.  
...
- **OSINT Publication Contributor** — *OSINTTeam.com* (Jul 2025 – Present)  
  - Writes technical explainers on cyber-intelligence and open-source analysis techniques.  

- **Aegis Club Activities** — *Dankook University*  
  - Designed and led web hacking practice sessions for new members.  
  - Co-developed internal security challenges and held peer code reviews.  
...
| Category | Skills |
|:----------|:--------|
| **Languages** | Python, C/C++, Java, JavaScript, C#, Dart (Flutter), LaTeX |
| **Security** | Android Malware Analysis, Digital Forensics, Cryptography, Web/Mobile Hacking |
| **AI/ML** | PyTorch, TensorFlow, Scikit-learn, LLM fine-tuning |
| **Frontend** | React, TailwindCSS, HTML5, Electron |
| **Backend** | Flask, FastAPI, Node.js, Firebase |
| **OS & Tools** | Linux/Ubuntu, Windows, GitHub, VS Code, Colab, Jupyter |
| **Design & Collaboration** | Figma, Canva, Adobe Illustrator, Notion, Overleaf, Slack |
...
> “Defense is not reactive — I design systems that learn, adapt, and secure by design.”  
> — Kyoungmin Roh
